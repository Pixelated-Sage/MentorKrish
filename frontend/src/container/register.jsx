      ...
      <main className="min-h-[70vh] flex flex-col justify-center items-center px-6 py-20 bg-w2">
        {success ? (
          <motion.div
            ...
            className="max-w-md bg-w1 rounded-3xl p-10 text-center shadow-xl border border-w2"
          >
            <h1 className="text-3xl font-bold mb-6">Thank you for registering!</h1>
            <p className="text-g2 mb-6">We’ve created your account. You can now log in.</p>
            <button
              onClick={() => router.push('/login')}
              className="bg-r1 text-w1 py-3 px-8 rounded-full hover:bg-r2 transition"
            >
              Go to Login
            </button>
          </motion.div>
