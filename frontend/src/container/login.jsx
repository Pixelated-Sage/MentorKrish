    ...
    <>
      ...
      <main className="min-h-screen flex flex-col justify-center items-center px-4 py-16 bg-w2 mt-18">
        <form onSubmit={handleSubmit} className="max-w-xl w-full space-y-6" noValidate>
          <h1 className="text-3xl font-bold text-center text-g1 mb-6 tracking-tight">Login to Your Account</h1>
        ...
        <button
          ...
          disabled={loading}
          className="mt-8 w-full max-w-xs flex items-center justify-center space-x-3 border border-gray-300 rounded-full py-3 text-gray-700 hover:bg-gray-100 transition"
